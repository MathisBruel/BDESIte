...
import { Texts, Event, TeamMember, Settings } from "@/lib/schemas";
...
export function HomeClient({
    ...
    // We use the full lists passed from server, but slice them based on state for "Show More" functionality
    // Note: Initial props 'upcomingEvents' and 'pastEvents' might be pre-sliced on server, 
    // but sticking to client-side slicing from the full list is easier given the original logic.
    // Actually, original logic sliced on client from full list.
                    ...
                    >
                        <div className="relative rounded-2xl overflow-hidden shadow-xl group">
                            ...
                            <Image
                                ...
                                loading="lazy"
                                placeholder="blur"
                                blurDataURL={getBlurPlaceholder("/images/team/groupe.jpg")}
                            />
