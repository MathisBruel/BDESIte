...
export function TeamCard({ member }: TeamCardProps) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-all p-6 text-center">
      ...
      <h3 className="text-lg font-bold font-spartan text-brand-black mb-1">{member.name}</h3>
      <p className="text-sm text-brand-red font-medium mb-4">{member.role}</p>
